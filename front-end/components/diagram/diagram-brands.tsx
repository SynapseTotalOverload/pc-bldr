...
import { CategoryButtons } from '../ui/category-buttons';
import { useBrands } from '@/hooks/graphs/useProductGraphsBrand';
...
const DiagramBrands = ({ data, onStartDateChange, onEndDateChange, onCategoryChange, onBrandChange }: DiagramBrandsProps) => {
    ...
    const { dataBrands, loading: brandsLoading, error: brandsError, refetch: brandsRefetch } = useBrands([categoryIdToString(selectedCategory as string)]);
