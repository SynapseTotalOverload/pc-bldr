...
export const playersApi = {
  ...
  updatePlayerGear: async (id: number, playerData: PlayerUpdateWithGear): Promise<PlayerWithRelations> => {
    const response = await axiosInstance.put(`players/${id}/gear`, playerData);
    return response.data;
  },
  ...
  removeSkinsFromPlayerBatch: async (playerId: number, skinIds: number[]): Promise<PlayerWithRelations> => {
    const response = await axiosInstance.delete(`players/${playerId}/skins/batch`, { 
