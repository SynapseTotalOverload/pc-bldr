      ...
      <div className="relative">
        <input
          ...
          className={cn(
            ...
            '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-black/70',
            '[&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-black/40',
            '[&::-webkit-slider-thumb]:shadow [&::-webkit-slider-thumb]:shadow-black/30',
            '[&::-webkit-slider-thumb]:backdrop-blur-sm [&::-webkit-slider-thumb]:transition-all',
            '[&::-webkit-slider-thumb]:hover:scale-110 [&::-webkit-slider-thumb]:hover:bg-black/90',
            '[&::-webkit-slider-thumb]:hover:border-black/70',
            ...
            '[&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-black/70',
            '[&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-black/60',
            '[&::-moz-range-thumb]:shadow-lg [&::-moz-range-thumb]:shadow-black/30',
            '[&::-moz-range-thumb]:backdrop-blur-md [&::-moz-range-thumb]:transition-all',
            '[&::-moz-range-thumb]:hover:scale-110 [&::-moz-range-thumb]:hover:bg-black/90',
            '[&::-moz-range-thumb]:hover:border-black/80',
