    ...
    <div className="bg-white rounded-lg shadow-md p-4 flex gap-4">
      ...
      <div className="flex-2">
        <ul className="flex flex-col gap-2">
          ...
          <li className="flex items-center gap-2">
            <a href={player.user_url?.instagram} target="_blank" rel="noopener noreferrer">
              <svg className="w-5 h-5 text-gray-600 cursor-pointer hover:text-pink-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <li className="flex items-center gap-2">
            <a href={player.user_url?.twitter} target="_blank" rel="noopener noreferrer">
              <svg className="w-5 h-5 text-gray-600 cursor-pointer hover:text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
          </li>
          <li className="flex items-center gap-2">
            <a href={player.user_url?.youtube} target="_blank" rel="noopener noreferrer">
              <svg className="w-5 h-5 text-gray-600 cursor-pointer hover:text-red-500" fill="currentColor" viewBox="0 0 24 24">
